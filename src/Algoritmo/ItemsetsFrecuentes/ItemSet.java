...
public class ItemSet implements Comparable <ItemSet> {
     private ArrayList<Integer> Elementos; // Elementos del itemset
    ...
    // Pregunta si el itemset tiene el elemento pasado como parametro 
    public boolean lotiene (String elemento){
     boolean bandera= false;
     int tamanio = this.getElementos().size();
     Integer elem= Integer.parseInt(elemento);
     for (int i=0; i<tamanio; i++){
         if (this.getElementos().get(i) == elem){
           bandera= true;
         }
     }
     return bandera;
    ...
    // Pregunta si el arreglo pasado como parametro es igual al itemset 
