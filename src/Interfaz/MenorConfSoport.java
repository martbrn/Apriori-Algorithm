    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        final SwingWorker worker = new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                Vent.setPath(path);
                Vent.setjTextPane2(MenorConfSoport.this.getMinSup());
        ...
        try {
            ...
            final SwingWorker worker= new SwingWorker(){
                ...
                protected Object doInBackground() throws Exception {
                    ...
                    MenorConfSoport.this.getComparaciones().add(compa); // Se guarda el objeto comparación a una lista para ser utilizado
                    ...
                    final SwingWorker worker2= new SwingWorker(){
                        ...
                        protected Object doInBackground() throws Exception {
                            ...
                            VentF.OrdenarReglas(); //Se ordenan las reglas segun la confianza y soporte
                            return null;
                        }
                    };
                    worker2.execute();
