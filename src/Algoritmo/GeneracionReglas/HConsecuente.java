...
public class HConsecuente {
    ...
    public boolean comparar (ItemSet uno, ItemSet dos, int barrera){
     ...
     int item= uno.getElementos().get(cont); // Obtiene el valor que se encuentra en la poscición que indica el contador
     int item2= dos.getElementos().get(cont); // Obtiene el valor que se encuentra en la poscición que indica el contador
     if (item != item2) { 
         return false;
     }
     cont=cont + 1;
